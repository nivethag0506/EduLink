    ...
    return (
        <div className="flex min-h-screen bg-slate-50">
            ...
            <div className="flex-1 ml-64 flex flex-col">
                {/* Top bar */}
                <header className="sticky top-0 z-40 h-16 bg-white/70 backdrop-blur-md border-b border-slate-100 flex items-center justify-end px-8">
                    <button
                    ...
                    >
                        ...
                        <span className="text-xs font-medium">Search people...</span>
                        <kbd className="ml-2 text-[10px] bg-slate-100 px-1.5 py-0.5 rounded-md border border-slate-200 font-mono text-slate-500">Ctrl K</kbd>
                    </button>
                </header>
